...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cumdwv44azfu.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'ilkerblog' # please enter your s3 bucket name
